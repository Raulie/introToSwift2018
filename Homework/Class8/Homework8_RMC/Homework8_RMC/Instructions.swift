...
//      a) When adding a new credit card, make the first name ready for input.
//      b) Automatically change the first character of each word to upper case.
//      c) Focus the next text field after pressing return or selecting an item in the picker view.
